...
defines = 'define lall = e+ mu+ e- mu- \ndefine vlall = ve vm vt ve~ vm~ vt~'
process = 'generate p p > h2 h2 lall lall lall vlall'


mAs = np.arange(mH, mH + 120, 20)
mHchs = np.arange(mH, mH + 120, 20)
